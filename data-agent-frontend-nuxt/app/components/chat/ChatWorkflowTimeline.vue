...
<template>
	<div ref="timelineRef" class="workflow-timeline">
		...
		<ChatExecutionBrief :node-blocks="nodeBlocks" />
...
import ChatExecutionBrief from './ChatExecutionBrief.vue';
...
const timelineSteps = computed<TimelineStep[]>(() => {
	...
	return groups.map((group, idx) => {
		...
		const resultSetText = [...block]
			.reverse()
			.find((item) => item.textType === TextType.RESULT_SET && item.text)?.text;
