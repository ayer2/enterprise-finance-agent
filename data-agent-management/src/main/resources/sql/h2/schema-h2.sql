...
CREATE INDEX IF NOT EXISTS idx_sql_audit_agent_time ON sql_audit_log(agent_id, created_time);
CREATE INDEX IF NOT EXISTS idx_sql_audit_actor_time ON sql_audit_log(actor_id, created_time);
CREATE INDEX IF NOT EXISTS idx_sql_audit_status ON sql_audit_log(status);
